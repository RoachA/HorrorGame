...
public class SimpleNavMeshPatroller : DynamicEntityModuleBase
{
    ...
    [CustomEditor(typeof(SimpleNavMeshPatroller))]
    public class PatrolManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SimpleNavMeshPatroller myScript = (SimpleNavMeshPatroller) target;
        ...
        {
            var patrolClass = target as SimpleNavMeshPatroller;
