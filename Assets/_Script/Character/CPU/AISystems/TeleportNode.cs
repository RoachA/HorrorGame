...
public class TeleportNode : EnemyActionNode
{
    ...
    public void Init(EnemyEntity parentModule)
    {
        m_actionNodeOwner = parentModule;
    }
    ...
    private void OnTeleportApproved()
    {
        ...
        switch (_afterTeleport)
        {
            ...
            case AfterTeleportBehavior.StayUntil:
                break;
            case AfterTeleportBehavior.PlayAnim:
                break;
            default:
        ...
        _bus.Fire(new CoreSignals.OnTeleportApprovedSignal(m_actionNodeOwner, transform.position, actionVar));
    }
