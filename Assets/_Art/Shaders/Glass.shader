...
Shader "Custom/Glass"
{
	Properties
	{
		...
		_Trasparency("Trasparency", Vector) = (0,0,0,0)
		_ColorSpread("Color Spread", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 transform32 = mul(GetObjectToWorldMatrix(),float4( -1,0,-1,0 ));
				float dotResult25 = dot( float4( WorldPosition , 0.0 ) , transform32 );
				float4 transform31 = mul(GetObjectToWorldMatrix(),float4( 0,-1,0,0 ));
				float dotResult24 = dot( float4( WorldPosition , 0.0 ) , transform31 );
				float2 appendResult37 = (float2(dotResult25 , dotResult24));
				float2 temp_output_35_0 = ( _MaskTile * float2( 2,2 ) );
				float4 transform30 = mul(GetObjectToWorldMatrix(),float4( 1,0,1,0 ));
				float dotResult27 = dot( float4( WorldPosition , 0.0 ) , transform30 );
				float2 appendResult29 = (float2(dotResult27 , 0.0));
				float4 lerpResult19 = lerp( tex2D( _NoiseMask, (appendResult37*temp_output_35_0 + 0.0) ) , tex2D( _NoiseMask, (appendResult29*temp_output_35_0 + 0.0) ) , (0));
				float4 lerpResult18 = lerp( tex2D( _NoiseMask, (appendResult37*_MaskTile + 1.0) ) , tex2D( _NoiseMask, (appendResult29*_MaskTile + 1.0) ) , (0));
				float4 Noise_Mask20 = saturate( ( lerpResult19 * lerpResult18 ) );
				float4 break43 = Noise_Mask20;
				float smoothstepResult46 = smoothstep( _ColorSpread.x , _ColorSpread.y , break43.g);
				float4 lerpResult44 = lerp( _GlassColor , float4( 0,0,0,0 ) , smoothstepResult46);
				
				float smoothstepResult50 = smoothstep( _Smoothness.x , _Smoothness.y , break43.g);
				
				float lerpResult41 = lerp( _Trasparency.x , _Trasparency.y , break43.r);
				...
				float Smoothness = smoothstepResult50;
				float Occlusion = 1;
				float Alpha = lerpResult41;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 transform32 = mul(GetObjectToWorldMatrix(),float4( -1,0,-1,0 ));
				float dotResult25 = dot( float4( ase_worldPos , 0.0 ) , transform32 );
				float4 transform31 = mul(GetObjectToWorldMatrix(),float4( 0,-1,0,0 ));
				float dotResult24 = dot( float4( ase_worldPos , 0.0 ) , transform31 );
				float2 appendResult37 = (float2(dotResult25 , dotResult24));
				float2 temp_output_35_0 = ( _MaskTile * float2( 2,2 ) );
				float4 transform30 = mul(GetObjectToWorldMatrix(),float4( 1,0,1,0 ));
				float dotResult27 = dot( float4( ase_worldPos , 0.0 ) , transform30 );
				float2 appendResult29 = (float2(dotResult27 , 0.0));
				float4 lerpResult19 = lerp( tex2D( _NoiseMask, (appendResult37*temp_output_35_0 + 0.0) ) , tex2D( _NoiseMask, (appendResult29*temp_output_35_0 + 0.0) ) , (0));
				float4 lerpResult18 = lerp( tex2D( _NoiseMask, (appendResult37*_MaskTile + 1.0) ) , tex2D( _NoiseMask, (appendResult29*_MaskTile + 1.0) ) , (0));
				float4 Noise_Mask20 = saturate( ( lerpResult19 * lerpResult18 ) );
				...
				surfaceDescription.Alpha = lerpResult41;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-1416.484,-13.50636;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;14;-2360.485,114.4936;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;15;-2360.485,322.4936;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SaturateNode;17;-1096.484,-109.5064;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;18;-1576.484,306.4936;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;19;-1592.484,-189.5064;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-2664.485,546.4936;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;2,2;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;22;-1960.485,114.4936;Inherit;False;-1;;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;24;-3816.485,-61.50636;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;25;-3800.485,210.4936;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;26;-4232.485,434.4936;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;27;-3800.485,514.4937;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;28;-4264.485,-157.5064;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DynamicAppendNode;29;-3160.485,178.4936;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;30;-4264.485,594.4936;Inherit;False;1;0;FLOAT4;1,0,1,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;31;-4264.485,18.49364;Inherit;False;1;0;FLOAT4;0,-1,0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;32;-4264.485,210.4936;Inherit;False;1;0;FLOAT4;-1,0,-1,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScaleAndOffsetNode;33;-2344.485,-109.5064;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;34;-2376.485,-253.5063;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-2680.485,-141.5064;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;2,2;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;36;-2984.485,34.49363;Inherit;False;Property;_MaskTile;Mask Tile;1;0;Create;True;0;0;0;False;0;False;1,1;0.31,0.39;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.DynamicAppendNode;37;-3224.485,-157.5064;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;12;-2008.485,-301.5064;Inherit;True;Property;_NoiseMask;Noise Mask;0;0;Create;True;0;0;0;False;0;False;-1;1af1adb124539d540ac51142e293e869;1af1adb124539d540ac51142e293e869;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;16;-1992.485,418.4936;Inherit;True;Property;_NoiseMask3;Noise Mask;0;0;Create;True;0;0;0;False;0;False;-1;1af1adb124539d540ac51142e293e869;1af1adb124539d540ac51142e293e869;True;0;False;white;Auto;False;Instance;12;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-1992.485,210.4936;Inherit;True;Property;_NoiseMask1;Noise Mask;0;0;Create;True;0;0;0;False;0;False;-1;1af1adb124539d540ac51142e293e869;1af1adb124539d540ac51142e293e869;True;0;False;white;Auto;False;Instance;12;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-2040.485,-77.50636;Inherit;True;Property;_NoiseMask2;Noise Mask;0;0;Create;True;0;0;0;False;0;False;-1;1af1adb124539d540ac51142e293e869;1af1adb124539d540ac51142e293e869;True;0;False;white;Auto;False;Instance;12;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;20;-871.788,-16.605;Inherit;False;Noise Mask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.BreakToComponentsNode;43;-590.5411,0.4940491;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.LerpOp;44;-103.6095,-170.7116;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;39;-602.4308,-436.2879;Inherit;False;Property;_GlassColor;Glass Color;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SmoothstepOpNode;46;-371.418,-157.497;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;589.8655,-128.2092;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Custom/Glass;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;20;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;1;638444957610147750;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;638450686066919766;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;0;638444972466755834;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;False;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.Vector2Node;47;-608.7834,-157.9543;Inherit;False;Property;_ColorSpread;Color Spread;4;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.LerpOp;41;-189.356,-13.52286;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;177.1957,-56.15747;Inherit;False;Property;_Metallic;Metallic;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;42;-672.356,176.4771;Inherit;False;Property;_Trasparency;Trasparency;3;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SmoothstepOpNode;50;116.5237,95.7078;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;49;-194.3763,285.1078;Inherit;False;Property;_Smoothness;Smoothness;5;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
